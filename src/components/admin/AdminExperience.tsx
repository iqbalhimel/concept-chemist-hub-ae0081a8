                ...
                <SortableRow key={item.id} id={item.id}>
                  <div className="glass-card p-4 flex items-center justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-foreground truncate">{item.job_title_en || "Untitled"}</p>
                      <p className="text-sm text-muted-foreground truncate">{item.institution_en} · {item.duration_en}</p>
                    </div>
