    ...
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <a href="https://wa.me/8801733579100" target="_blank" rel="noopener noreferrer" aria-label={t.whatsapp.tooltip}
        ...
        <TooltipContent side="left" className="font-medium">{t.whatsapp.tooltip}</TooltipContent>
      </Tooltip>
    </TooltipProvider>
  );
};
